...
public class Utils extends BasePage{
    ...
    public static void waitforframetobeavailable(By by, int time){
        WebDriverWait wait = new WebDriverWait(driver, time);
    ...
    public static String verifyandgetTitle(String expected) {//to verify and get title
        String title = driver.getTitle();
        Assert.assertEquals(title, expected,"Title does not match");
        return title;
    }
    public static String validateURL(String expected) {
